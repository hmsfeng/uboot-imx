cmd_drivers/video/mxsfb.o := arm-linux-gnueabihf-gcc -Wp,-MD,drivers/video/.mxsfb.o.d  -nostdinc -isystem /home/vmuser/6Y2C/gcc-linaro-arm-linux-gnueabihf-4.9-2014.09_linux/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -fshort-wchar -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(mxsfb)"  -D"KBUILD_MODNAME=KBUILD_STR(mxsfb)" -c -o drivers/video/mxsfb.o drivers/video/mxsfb.c

source_drivers/video/mxsfb.o := drivers/video/mxsfb.c

deps_drivers/video/mxsfb.o := \
    $(wildcard include/config/video/gis.h) \
    $(wildcard include/config/imx/mipi/dsi/bridge.h) \
    $(wildcard include/config/imx/sec/mipi/dsi.h) \
