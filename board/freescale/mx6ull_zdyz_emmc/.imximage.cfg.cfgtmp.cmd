cmd_board/freescale/mx6ull_zdyz_emmc/imximage.cfg.cfgtmp := arm-linux-gnueabihf-gcc -E -Wp,-MD,board/freescale/mx6ull_zdyz_emmc/.imximage.cfg.cfgtmp.d  -nostdinc -isystem /home/vmuser/6Y2C/gcc-linaro-arm-linux-gnueabihf-4.9-2014.09_linux/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__    -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations  -fno-pic  -mno-unaligned-access  -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float   -pipe  -march=armv7-a -D__LINUX_ARM_ARCH__=7     -x c -o board/freescale/mx6ull_zdyz_emmc/imximage.cfg.cfgtmp board/freescale/mx6ull_zdyz_emmc/imximage.cfg

source_board/freescale/mx6ull_zdyz_emmc/imximage.cfg.cfgtmp := board/freescale/mx6ull_zdyz_emmc/imximage.cfg

deps_board/freescale/mx6ull_zdyz_emmc/imximage.cfg.cfgtmp := \
    $(wildcard include/config/qspi/boot.h) \
    $(wildcard include/config/nor/boot.h) \
    $(wildcard include/config/use/imximg/plugin.h) \
...
board/freescale/mx6ull_zdyz_emmc/imximage.cfg.cfgtmp: $(deps_board/freescale/mx6ull_zdyz_emmc/imximage.cfg.cfgtmp)
